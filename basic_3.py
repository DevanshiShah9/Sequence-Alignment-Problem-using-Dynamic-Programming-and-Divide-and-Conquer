...
class Sequence_Alignment_Basic:
...
def basic_implementation(in_file_loc,out_file_loc):
...
if __name__ == '__main__':
    param_list = basic_implementation(sys.argv[-2],sys.argv[-1])
